...
import {DynamicFormControlType, ISubmit} from "../../../utils/models/Form.interface";
...
export class SubmitComponent extends SharedFeaturesBaseComponent<ISubmit> implements OnInit, OnDestroy {
